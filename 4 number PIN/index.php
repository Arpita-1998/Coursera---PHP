<!DOCTYPE html>
<head><title>Arpita Mangaraj MD5 Cracker</title></head>
<body>
<h1>MD5 cracker</h1>
...
if ( isset($_GET['md5']) ) {
    ...
    // Outer loop go go through the PIN for the
    // first position in our "possible" pre-hash
    // text
    for($i=0; $i<strlen($txt); $i++ ) {
        $ch1 = $txt[$i];   // The first of 4 numbers
...
<form>
<input type="text" name="md5" size="60" value="<?= htmlentities($md5) ?>"/>
...
target="_blank"> Source code for similar to this application </a></li>
</ul>
</body>
</html>
